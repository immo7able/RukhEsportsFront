...
const TMOB = () => {
  ...
  return (
    <div>
      <TournamentsTabs baseRoute="tournaments/mob" selectedTab={selectedTab} handleTabChange={handleTabChange} />
      <TournamentList tournamentsData={tournaments} type="MOB" status={selectedTab} />
    </div>
  );
};
